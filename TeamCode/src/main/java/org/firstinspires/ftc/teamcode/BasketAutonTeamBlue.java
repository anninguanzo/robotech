...
@Autonomous
public class BasketAutonTeamBlue extends LinearOpMode {
    @Override
...
class BasketLiftActionBlue implements Action {
    DcMotor liftMotor, liftMotor1;
    double power;
    ElapsedTime timer;
    double time;
    public BasketLiftActionBlue(DcMotor liftMotor, DcMotor liftMotor1, double power, double time){
...
class BasketIntakeArmActionBlue implements Action {
    Servo arm;
    double position;
    public BasketIntakeArmActionBlue(Servo arm, double position){
        this.arm = arm;
...
class BasketIntakeGearActionBlue implements Action {
    CRServo gear;
    double power;
    double time;
    ElapsedTime timer;
    public BasketIntakeGearActionBlue(CRServo gear, double power, double time){
        this.gear = gear;
        this.power = power;
        this.time = time;
    }
