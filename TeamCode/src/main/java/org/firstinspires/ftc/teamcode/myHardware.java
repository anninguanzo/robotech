...
public class myHardware {
    ...
    public void init(HardwareMap ahwMap){
        hwMap = ahwMap;
        LFMotor = hwMap.get(DcMotorEx.class, "motor2");
        LBMotor = hwMap.get(DcMotorEx.class, "motor3");
        RBMotor = hwMap.get(DcMotorEx.class, "motor");
        RFMotor = hwMap.get(DcMotorEx.class, "motor1");
