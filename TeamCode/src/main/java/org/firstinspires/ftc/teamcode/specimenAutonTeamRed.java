    ...
    public void runOpMode() throws InterruptedException{
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(-12,30,Math.toRadians(90)))
                        ...
                        .lineToX(0)
                        .lineToY(13)
                        .stopAndAdd(new LiftActionRedd(liftMotor, liftMotor1, 2, 2))
                        .stopAndAdd(new LiftActionRedd(liftMotor, liftMotor1, -2, 2))
...
class LiftActionRedd implements Action {
    DcMotor liftMotor, liftMotor1;
    double power;
    ElapsedTime timer;
    double time;
    public LiftActionRedd(DcMotor liftMotor, DcMotor liftMotor1, double power, double time){
